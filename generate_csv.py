...
for t in calibre_titles:
    data.append({"App": "Calibre", "Title": t})
...
for t in yes24_titles:
    data.append({"App": "YES24", "Title": t})
...
for t in aladin_titles:
    data.append({"App": "Aladin", "Title": t})

# Bookcube
data.append({"App": "Bookcube", "Title": "동태적 거시경제학 -성장과 변동-"})

filename = r"c:\Users\kkmin\Desktop\ebook\ebook_list.csv"
